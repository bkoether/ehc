...
<tbody>
	...
	<tr>
		...
		<td colspan="1"><?php print $submission->data[141][value][0];?></td>
	</tr>
	<tr>
		<th colspan="4">&nbsp;</th>
		<td></td>
...
<tbody>
	...
	<tr>
		...
		<td colspan="2"><?php print cleannum($submission->data[119][value][0]) * 1.89271;?></td>
		<td><?php print $submission->data[121][value][0];?></td>
	</tr>
	<tr>
		<th colspan="3">2 Litres</th>
	...
	<tr>
		...
		<td colspan="2"><?php print cleannum($submission->data[127][value][0]) * 3.78541;?></td>
	...
	<tr>
		...
		<td colspan="2"><?php print cleannum($submission->data[10][value][0]) * 5;?></td>
		<td><?php print $submission->data[129][value][0];?></td>
	</tr>
	<tr>
		<th colspan="3">7.56 Litres</th>
	...
	<tr>
		...
		<td colspan="2"><?php print cleannum($submission->data[151][value][0]) * 9.46353;?></td>
	...
	<tr>
		<th colspan="3">15 Litres</th>
		<td colspan="2"><?php print cleannum($submission->data[89][value][0]) * 15;?></td>
